window.onload = function() {
  // capturamos el boton buscar y cuando se haga click en este, hace una animación y aparece el buscador que no estaba//
      ...
      fetch("https://api.themoviedb.org/3/movie/upcoming?api_key=ccaee37d8fbe5010cfb857e26fcce8d4&page=1")
        ...
        .then(function(datos) {
          ...
          for (var i = 0; i < estrenos.length; i++) {
            document.querySelector(".estrenos").innerHTML+= '<li><a href="detalle.html?idDePelicula='+estrenos[i].id +'"><img src="https://image.tmdb.org/t/p/original/' + estrenos[i].poster_path + '" alt=""></a></li>'
          }
        ...
        fetch("https://api.themoviedb.org/3/movie/top_rated?api_key=ccaee37d8fbe5010cfb857e26fcce8d4&page=1")
          ...
          .then(function(datos) {
            ...
            for (var i = 0; i < puntaje.length; i++) {
              document.querySelector(".puntaje").innerHTML+= '<li><a href="detalle.html?idDePelicula='+ puntaje[i].id+'"><img src="https://image.tmdb.org/t/p/original/' + puntaje[i].poster_path + '" alt=""></a></li>'
            }
          ...
          fetch("https://api.themoviedb.org/3/movie/popular?api_key=ccaee37d8fbe5010cfb857e26fcce8d4&page=1")
            ...
            .then(function(datos) {
              ...
              for (var i = 0; i < populares.length; i++) {
                document.querySelector(".populares").innerHTML+= '<li ><a href="detalle.html?idDePelicula='+populares[i].id+'"><img src="https://image.tmdb.org/t/p/original/' + populares[i].poster_path + '" alt=""></a></li>'
              }
