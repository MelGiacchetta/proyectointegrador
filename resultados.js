  ...
  fetch("https://api.themoviedb.org/3/search/movie?api_key=ccaee37d8fbe5010cfb857e26fcce8d4&language=en-US&query=resultados&page=1&include_adult=false" + idResultados)
    ...
    .then(function(datos) {
      ...
      for (var i = 0; i < resultados.length; i++) {
        document.querySelector(".busqueda").innerHTML += '<li ><img src="https://image.tmdb.org/t/p/original/' + resultados[i].poster_path + '"alt=""> <div class="uk-position-center uk-panel"></div></li>'
      }
